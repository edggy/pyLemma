...
try:
    ...
    if flags["p"].lower() in english:
        ...
        printProof = lambda x: printers.englishProofPrinter(
            x,
            howToPrint=syntax,
            inferencePrinter=infPrint,
            linePrinter=linePrint,
            sentencePrinter=senPrint,
        )
        ...
        printProof = lambda x: printers.latexProofPrinter(
            x,
            howToPrint=syntax,
            inferencePrinter=infPrint,
            linePrinter=linePrint,
        ...
        printProof = lambda x: printers.defaultProofPrinter(
            x,
            inferencePrinter=infPrint,
            linePrinter=linePrint,
            sentencePrinter=senPrint,
    ...
    # printProof = lambda x: printers.compressedProofPrinter(x, sentencePrinter =
    # printers.prefixSentencePrinter)
    ...
    while not done:
        ...
        proofName = input("Which proof would you like to print?  (type done to exit) ")
