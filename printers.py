...
def latexLinePrinter(line, sentencePrinter=None, howToPrint=None, inline=False):
    ...
    try:
        ...
        if line._inference is not None:
            ...
            inf = str(line._inference.name)
            replacements = {
                "Contradiction Intro": "$\\bot$ Intro",
                "Contradiction Elim": "$\\bot$ Elim",
                "And Intro": "$\land$ Intro",
                "And Elim Left": "$\land$ Elim",
                "And Elim Right": "$\land$ Elim",
                "Or Intro Left": "$\lor$ Intro",
                "Or Intro Right": "$\lor$ Intro",
                "Or Elim": "$\lor$ Elim",
                "Not Intro": "$\lnot$ Intro",
                "Not Elim": "$\lnot$ Elim",
                "If Intro": "$\lif$ Intro",
                "If Elim": "$\lif$ Elim",
                "Iff Intro": "$\liff$ Intro",
                "Iff Elim Left": "$\liff$ Elim",
                "Iff Elim Right": "$\liff$ Elim",
                "ForAll Intro": "$\lall$ Intro",
                "ForAll Elim": "$\lall$ Elim",
                "Exists Intro": "$\lis$ Intro",
                "Exists Elim": "$\lis$ Elim",
            }
